...
ft1 = ImageFont.truetype("fonts\\AVGBBMV_rev.ttf", 55)  # 发票代码字体
ft2 = ImageFont.truetype("fonts\\fuhun_piao2.ttf", 50)  # 发票号码字体
ft3 = ImageFont.truetype("fonts\\AVGBBMV_rev.ttf", 25)
ft4 = ImageFont.truetype("fonts\\AVGBBMV_rev.ttf", 30)
ft5 = ImageFont.truetype("fonts\\华文中宋.ttf", 23)  # 开票日期字体

ft6 = ImageFont.truetype("fonts\\汉仪粗仿宋简.ttf", 25)  # 名称字体
ft7 = ImageFont.truetype("fonts\\cour.ttf", 32)  # 纳税人识别号字体
ft8 = ImageFont.truetype("fonts\\汉仪粗仿宋简.ttf", 22)  # 地址电话字体
ft9 = ImageFont.truetype("fonts\\cour.ttf", 35)  # 密码区字体
ft10 = ImageFont.truetype("fonts\\cour.ttf", 32)  # 总金额，总税额字体
ft11 = ImageFont.truetype("fonts\\simsun.ttc", 25)
ft12 = ImageFont.truetype("fonts\\Deng.ttf", 30)  # 金额￥字体
ft13 = ImageFont.truetype("fonts\\AVGBBMV_rev.ttf", 25)  # 单价等字体
